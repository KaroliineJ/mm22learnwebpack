...
export default {
  created() {
    ...
    // Add a setInterval function to simulate auto-clicking for Auto Clicker upgrades
    setInterval(() => {
      this.cookies += this.upgrades.autoClicker.cps;
    }, 1000);
  },
  data() {
    return {
      ...
      upgrades: {
        ...
        autoClicker: {price: 500, cps: 5, count: 0}, // Auto Clicker upgrade
      }
    };
  },
  methods: {
